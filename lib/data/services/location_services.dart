...
//   // getLocationNameByCoordinate() async {
...
//   //   // }
//   // }
//   Future<void> getLocationNameByCoordinate() async {
//     try {
//       Position currentPosition = await _determinePosition();
//       print("lat : ${currentPosition.latitude}");
//       print("long : ${currentPosition.longitude}");
...
// );
    ...
    print(">>> hasil : ${currentPosition.longitude}");
    print(">>> hasil : ${currentPosition.latitude}");
    ...
    try {
      ...
      // });
      print(
          ">>> ${place.name} -  ${place.administrativeArea} - ${place.locality}, ${place.postalCode}, ${place.country}");
    } catch (e) {
      print(e);
    }
  }
